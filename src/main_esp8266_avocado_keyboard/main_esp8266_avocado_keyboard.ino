...
// update max speed
#define UP_SPEED_BUTTON "+39"
#define DOWN_SPEED_BUTTON "+37"
...
void robot_main() {
  ...
  if (esp.available()) {
    ...
    // run motors
    int left_speed = constrain(forward_vector*FORWARD_VECTOR_K-left_vector*LEFT_VECTOR_K,-max_motor_speed,max_motor_speed);
    int right_speed = constrain(forward_vector*FORWARD_VECTOR_K+left_vector*LEFT_VECTOR_K,-max_motor_speed,max_motor_speed);
    #ifdef DEBUG_SERIAL
